...
import systems.cauldron.http.v2.http.HttpRequestMethod;
...
public class RawHttpRequest {
    ...
    public String parsePath() {
        return new String(source, path.start, path.end, StandardCharsets.US_ASCII);
    }

    public HttpProtocol parseProtocol() {
        int length = method.end - method.start;
        if (length == 8) {
            if (source[method.start] == 72 &&
                    source[method.start + 1] == 84 &&
                    source[method.start + 2] == 84 &&
                    source[method.start + 3] == 80 &&
                    source[method.start + 4] == 47 &&
                    source[method.start + 5] == 49 &&
                    source[method.start + 6] == 46 &&
                    source[method.start + 7] == 49) {
        ...
        switch (method.end - method.start) {
            case 3:
                ...
                switch (source[method.start]) {
                    case 71:
                        if (source[method.start + 1] == 69 &&
                                source[method.start + 2] == 84) {
                            return HttpRequestMethod.GET;
                        }
                        break;
                    case 80:
                        if (source[method.start + 1] == 85 &&
                                source[method.start + 2] == 84) {
            ...
            case 4:
                ...
                switch (source[method.start]) {
                    case 80:
                        if (source[method.start + 1] == 79 &&
                                source[method.start + 2] == 83 &&
                                source[method.start + 3] == 84) {
                            return HttpRequestMethod.POST;
                        }
                        break;
                    case 72:
                        if (source[method.start + 1] == 69 &&
                                source[method.start + 2] == 65 &&
                                source[method.start + 3] == 68) {
            ...
            case 5:
                ...
                switch (source[method.start]) {
                    case 84:
                        if (source[method.start + 1] == 82 &&
                                source[method.start + 2] == 65 &&
                                source[method.start + 3] == 67 &&
                                source[method.start + 4] == 69) {
                            return HttpRequestMethod.TRACE;
                        }
                        break;
                    case 80:
                        if (source[method.start + 1] == 65 &&
                                source[method.start + 2] == 84 &&
                                source[method.start + 3] == 67 &&
                                source[method.start + 4] == 72) {
            ...
            case 6:
                //DELETE
                if (source[method.start + 1] == 68 &&
                        source[method.start + 2] == 69 &&
                        source[method.start + 3] == 76 &&
                        source[method.start + 4] == 69 &&
                        source[method.start + 5] == 84 &&
                        source[method.start + 6] == 69) {
            ...
            case 7:
                ...
                switch (source[method.start]) {
                    case 79:
                        if (source[method.start + 1] == 80 &&
                                source[method.start + 2] == 84 &&
                                source[method.start + 3] == 73 &&
                                source[method.start + 4] == 79 &&
                                source[method.start + 5] == 78 &&
                                source[method.start + 6] == 83) {
                            return HttpRequestMethod.OPTIONS;
                        }
                        break;
                    case 67:
                        if (source[method.start + 1] == 79 &&
                                source[method.start + 2] == 78 &&
                                source[method.start + 3] == 78 &&
                                source[method.start + 4] == 69 &&
                                source[method.start + 5] == 67 &&
                                source[method.start + 6] == 84) {
