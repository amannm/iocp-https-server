...
import ontoserv.http.util.constants.HttpStatus;
import ontoserv.http.util.constants.HttpResponseHeader;
...
import ontoserv.http.util.SimpleCompletionHandler;
import ontoserv.http.util.constants.CacheControl;
import ontoserv.http.util.constants.HttpConnectionHeader;
import ontoserv.http.util.constants.HttpContentCoding;
import ontoserv.http.util.constants.HttpStrictTransportSecurityHeader;
